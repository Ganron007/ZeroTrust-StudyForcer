...
├── news-storage.test.ts         # 24 — parseRss, urlToDomain, timeAgo, readNewsCache (post-v2.6.0)
├── lab-session-storage.test.ts  # 35 — S4/S5/S6 validators, getStreak, computeSmartScore (post-v2.6.0)
